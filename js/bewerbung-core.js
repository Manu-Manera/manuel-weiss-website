// =================== SMART BEWERBUNGSMANAGER CORE SYSTEM ===================
// Haupt-Koordinator für den modularen Smart Bewerbungsmanager
// Lädt und koordiniert alle Bewerbungs-Schritte

// Global Bewerbungs Data
window.bewerbungData = {
    currentStep: 1,
    company: '',
    position: '',
    jobDescription: '',
...
window.workflowData = window.bewerbungData;

// Module Loading System
const BewerbungsCore = {
    ...
    async loadModule(stepName) {
        ...
        try {
            ...
            script.src = `js/bewerbung-steps/bewerbung-${stepName}.js`;
            script.async = false;
